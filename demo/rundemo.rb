...
map.background = Mapnik::Color.new(255,255,255,255)
...
province_polygon_symbolizer.fill = Mapnik::Color.new(250, 190, 183, 255)
...
province_polygon_symbolizer_qc.fill = Mapnik::Color.new(217, 235, 203, 255)
...
qcdrain_polygon.fill = Mapnik::Color.new(153, 204, 255, 255)
...
provlines_color = Mapnik::Color.new(0,0,0,255)
...
roads34_rule_stk = Mapnik::Stroke.new(Mapnik::Color.new(171,158,137, 255), 2.0)
...
roads2_rule_stk_1 = Mapnik::Stroke.new(Mapnik::Color.new(171,158,137, 255), 4.0)
...
roads2_rule_stk_2 = Mapnik::Stroke.new(Mapnik::Color.new(255,250,115, 255), 2.0)
...
roads1_rule_stk_1 = Mapnik::Stroke.new(Mapnik::Color.new(188,149,28, 255), 7.0) 
...
roads1_rule_stk_2 = Mapnik::Stroke.new(Mapnik::Color.new(242,191,36, 255), 5.0)
...
text_color = Mapnik::Color.new(0,0,0,255)
...
popplaces_text_symbolizer.halo_fill = Mapnik::Color.new(255,255,255,255)
